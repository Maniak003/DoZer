...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((data != null) && (requestCode == 2)) {
            ...
            for (int jj = 0; jj < 4; jj++) {
                for (int i = 0; i < 2; i++) {
                    resData[1 - i + jj * 2] = ByteBuffer.allocate(4).putInt(Objects.requireNonNull(data.getIntArrayExtra("CFGDATA1"))[jj]).get(i + 2);
                }
            }
            ...
            /* Radiation levels */
            Trh1 = Objects.requireNonNull(data.getIntArrayExtra("CFGDATA1"))[1];
            if (Trh1 == 0)
                Trh1 = 30;
            Trh2 = Objects.requireNonNull(data.getIntArrayExtra("CFGDATA1"))[2];
            if (Trh2 == 0)
                Trh2 = 60;
            Trh3 = Objects.requireNonNull(data.getIntArrayExtra("CFGDATA1"))[3];
            if (Trh3 == 0)
                Trh3 = 100;
            ...
            correctA = Objects.requireNonNull(data.getFloatArrayExtra("CFGDATA16"))[0];
            correctB = Objects.requireNonNull(data.getFloatArrayExtra("CFGDATA16"))[1];
            correctC = Objects.requireNonNull(data.getFloatArrayExtra("CFGDATA16"))[2];
    ...
    */
    ...
    @SuppressLint({"ClickableViewAccessibility", "HandlerLeak", "NewApi", "MissingPermission"})
    ...
    public class DrawAll {
        ...
        public void drawCursor(float X, float Y) {
            if (cursorCanvas == null) {
                ...
                empt.setFilterBitmap(false);
                empt.setAntiAlias(false);
                empt.setDither(false);
                curs.setColor(Color.argb(255, 0, 255, 0));
                curs.setTextSize(20.0f);
                curs.setFilterBitmap(false);
                curs.setAntiAlias(false);
                curs.setDither(false);
            } else {
                hideCursor();
                cursorHideFlag = 1;
                oldX = X;
        ...
        public void writeHistogram(Canvas canvas, Canvas histCanvas) {
            ...
            /*
            pFindData1.setFilterBitmap(false);
            pFindData1.setAntiAlias(false);
            pFindData1.setDither(false);
            pFindData2.setFilterBitmap(false);
            pFindData2.setAntiAlias(false);
            pFindData2.setDither(false);
            pFindData3.setFilterBitmap(false);
            pFindData3.setAntiAlias(false);
            pFindData3.setDither(false);
            */
